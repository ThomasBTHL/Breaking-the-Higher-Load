...
pitcher = 'PP12' #PP01 - PP15
Innings = ['Inning_1','Inning_2','Inning_3','Inning_4','Inning_5','Inning_6','Inning_7'] # Inning where you want to look, for pitches gives all pitches in inning
...
mean_forearm_length = 28.558536329757345
mean_upperarm_length = 26.62293795296906
mean_hand_length = 21.275768434465704
...
for Inning in Innings:
    ...
    for pitch_number in inning_data:
        ...
        if (np.isnan(np.nanmean(M_joint['hand']['M_proximal'])) == False) and (
            ...
            max_M_index = np.nanargmax(seg_M_joint['forearm'][2,:])
