...
path = os.path.abspath(os.path.join("data/PP02/No tape/Pitch_01/"))
...
if choice in yes:
    ...
    visual_check_markers_switching('RUS', 'RRS', 'RMHE', 'RLHE', markers,title='ForeArm')

    # Check right shoulder and for switching
    #visual_check_markers('RAC1', 'RAC2', 'RAC3', [], markers)
    visual_check_markers_switching('RAC1', 'RAC2', 'RAC3', [], markers, title='Shoulder')

    # Check Trunk markers
    #visual_check_markers('IJ', 'PX', 'C7', 'T8', markers)
    visual_check_markers_switching('IJ', 'PX', 'C7', 'T8', markers,title='Trunk')

    # Check Pelvic markers
    #visual_check_markers('LASIS', 'RASIS', 'LPSIS', 'RPSIS', markers)
    visual_check_markers_switching('LASIS', 'RASIS', 'LPSIS', 'RPSIS', markers, title='Pelvic')
else:
