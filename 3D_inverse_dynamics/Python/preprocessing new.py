...
for Innings in markers_c3d:
    inning_name = "Inning_{0}".format(j+1)
    ...
    if choice in yes:
        if 'markersFilter' in locals():
            ...
            markers_cut_pickle_jar = markers_c3d.copy()
            markers_cut_pickle_jar['PITCH_0'] = markers_cut
            ...
            # Write the dictionary into the binary file
            pickle.dump(markers_cut_pickle_jar, outfile)
            outfile.close()
